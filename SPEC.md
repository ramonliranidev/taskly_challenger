...
- [ ] Autenticação própria (cadastro, login, sessão persistente)
- [ ] CRUD de Projetos
...
- **Autenticação:** Laravel Sanctum, com tokens/cookies para consumo pela SPA Angular.
- **Comunicação Front/Back:** API REST em JSON.
